...
<html>
  ...
  <div class="contenedor-enlaces">
    ...
    <div>
        <a href="Preguntas.php"> <img class="item-banner"src="img/conversation.png" height="150" width= "150"> <br /> </a>
    <dc> Preguntas más frecuentes </dc>
    </div> <br />
    <div>
        <a href="Informacion.php"> <img class="item-banner"src="img/informacion.png" height="150" width= "150"> <br /> </a>
        <dc> Información de la empresa </dc>
    </div> <br />
    <div>
      <a href="consultas2.php"> <img class="item-banner"src="img/consulta.png" height="150" width= "150"> <br /> </a>
        <dc> Consultas </dc>
    </div> <br />
