...
if (isset($_GET['idsubcategoria'])) {
    ...
    $resultado3 = $conexion->query("SELECT * FROM subcategorias WHERE idsubcategoria=".$idsubcategoria) or die($conexion->error);
...
<div class="container">
    ...
    <?php
     $idprod = $fila2['idSubCategoria'];
     $sentencia=$pdo->prepare("SELECT *FROM `productos` WHERE subCategoria_idSubCategoria =" .$idprod);
     $sentencia->execute();
    ...
    <?php foreach($listaProductos as $producto){ ?>
      <div class="col-3">
        <div class="card">
          ...
          alt="<?php echo $producto['marca'];?>"
          class="card-img-top" 
          src="<?php echo $producto['imagen'];?>"
          data-toggle="popover"
          data-trigger="hover"
          data-content="<?php echo $producto['descripcion'];?>"
          data-content="<?php echo $producto['referencias'];?>"
          height="317px"
          href = "<?php echo"producto.php?idprod=". $producto['idProductos']; ?>"
          >
          <div class="card-body">
            <span><a href=<?php echo"producto.php?idprod=". $producto['idProductos']; ?>><?php echo $producto['nombre'];?></a></span>
