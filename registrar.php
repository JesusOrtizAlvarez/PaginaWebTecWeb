...
<html>
  ...
  <body>
    ...
    <form action= "validacionRegistro.php" method="POST" class="formulario_register">
      <h1>Regístrate</h1>
      <div class="contenedor">
        ...
        <div class="input-contenedor">
          ...
          <input type="text" placeholder="Número de telefono" name = "numTelf" />
        </div>
        ...
        <div>
          <input type="submit" value="Crea tu cuenta" class="button" />
        </div>
        <p>
          Al registrate, aceptas nuestras Condiciones de Uso y Politica de
          Privacidad.
        </p>
