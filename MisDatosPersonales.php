...
<head>
    ...
    <link rel="stylesheet" href="css/datosPersonales19.css" />
    <link
      rel="stylesheet"
  ...
  <div class="divGeneralMisDatos">
        ...
        <nav class="navMenuLateral">
            <ul class="ulMiCuenta">
              <li class="flecha">
                ...
                <li class="liMenuLateral">
                    <div class="barra"></div>
                    <p class="menuLateralSelect">Mis datos personales</p>
                </li>
                </a>
      ...
      <div class="divDatos1">
        <nav>
          <ul class="ulDatos">
            <li class="liDatos">
              <p class="pDatos">Datos personales</p>
            </li>
            <li class="correoPass">
              <p class="textoCP">Correo electronico</p>
              <p class="textoCP"><?=$_SESSION['correo']?></p>
            </li>
            <br>
          </ul>
        </nav>
      ...
      <div class="divDatos2">
        <nav>
          <ul class="ulDatos">
            <li class="liDireccionesTitulo">
              <p class="pMisDirecciones">Mis direcciones</p>
            </li>
            <?php
            ...
            <li class="direcciones">
              <p class="pNombre"><?php echo $fila['nombre'] ?></p>
              <p class="pDirec1">DNI: <?php echo $fila['DNI'] ?></p>
              <p class="pDirec1">Codigo Postal: <?php echo $fila['codigoPostal'] ?></p>
              <p class="pDirec2"> <i class="fas fa-check-circle" id="tick1"></i> <?php echo $fila['direccion'] ?></p>
            </li>
          </ul>
           <?php } ?>
        </nav>
