                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            ...
                            Tabla de Productos <a href="AgregarProAdmin.php" class="btn btn-primary btn-sm" style="position: absolute; right: 0;">Agregar</a>
                        </div>
                        <div class="card-body">
                                                ...
                                                <table class="table table-bordered">
                                                    <thead>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th class="product-fab">Fabricante</th>
                                                ...
                                                while ($fila = mysqli_fetch_array($sql)) {
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td><a href=<?php echo"EditarProAdmin.php?idProd=". $fila['idProductos']; ?> class="btn btn-primary btn-sm">Editar</a></td>
                                                            <td><a href=<?php echo"eliminarProd.php?idProd=". $fila['idProductos']; ?> class="btn btn-primary btn-sm">X</a></td>
                                                        </tr>
                                                        <?php }
                                                 ?>
