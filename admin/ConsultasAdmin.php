                                                ...
                                                <table class="table table-bordered">
                                                    <thead>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th class="product-price">Consulta</th>
                                                ...
                                                while ($fila = mysqli_fetch_array($sql)) {
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td><a class="btn btn-primary btn-sm" href=<?php echo"eliminarConAdmin.php?idCon=". $fila['idConsulta']; ?>>X</a></td>
                                                        </tr>
