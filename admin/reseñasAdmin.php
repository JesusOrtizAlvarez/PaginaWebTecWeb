                                            ...
                                            <div class="site-blocks-table">
                                                <table class="table table-bordered">
                                                    <thead>
                                                        <br>
                                                        <tr>
                                                            <th class="product-thumbnail">Correo</th>
                                                            <th class="product-name">Comentario</th>
                                                ...
                                                while ($fila = mysqli_fetch_array($sql)) {
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td><a href="<?php echo"eliminarComen.php?idCom=". $fila['id']; ?>" class="btn btn-primary btn-sm" >X</a></td>
                                                        </tr>
                                                        <?php }
                                                 ?>
